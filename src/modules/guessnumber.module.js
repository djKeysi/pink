...
export class GuessNumber extends Module {
    ...
    setCreateForm(){
       ...
       this.$inputElement.style.margin = '18px';
        ...
        this.$divElement.append(this.$inputElement,this.$buttonElement,  this.$buttonElementHome,this.$divElementLabel);
        document.body.append(this.$divElement);

        this.$buttonElement.addEventListener('click', this.handleButton.bind(this));
        this.$inputElement.addEventListener('input', this.handleInput.bind(this));
        this.$buttonElementHome.addEventListener('click', this.handleButtonHome.bind(this));
